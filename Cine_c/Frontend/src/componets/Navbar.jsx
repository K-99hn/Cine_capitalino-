      ...
      <div className="w-full px-4 sm:px-6">
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          <div className="flex space-x-1 bg-gray-800/60 backdrop-blur-sm p-1 rounded-xl sm:rounded-2xl">
            ...
            <Link
              to="/cartelera"
              className={`flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm ${location.pathname === "/cartelera" ? active : inactive
                }`}
            >
            ...
            <Link
              to="/ventas"
              className={`flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm ${location.pathname === "/ventas" ? active : inactive
                }`}
            >
